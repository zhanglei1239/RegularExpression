...
- (UILabel *)makeViewOfMessage:(NSString *)msg withColorType:(int)colorType
{
    ...
    UILabel * messageLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,0, SCREEN_WIDTH,CSToastHeight)];
    ...
    messageLabel.center =CGPointMake(SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
